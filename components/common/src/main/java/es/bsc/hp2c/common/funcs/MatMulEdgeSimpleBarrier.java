 ...
 */
public class MatMulEdgeSimpleBarrier extends Func {
    ...
    public MatMulEdgeSimpleBarrier(Map<String, ArrayList<Sensor<?, ?>>> sensors,
    ...
    public static interface COMPSsItf {
        ...
        @Method(declaringClass = "es.bsc.hp2c.common.funcs.MatMulEdgeSimpleBarrier")
