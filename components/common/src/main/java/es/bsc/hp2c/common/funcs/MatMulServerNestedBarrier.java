 ...
 */
public class MatMulServerNestedBarrier extends Func {
    ...
    public MatMulServerNestedBarrier(Map<String, ArrayList<Sensor<?, ?>>> sensors,
    ...
    public static interface COMPSsItf {
        ...
        @Method(declaringClass = "es.bsc.hp2c.common.funcs.MatMulServerNestedBarrier")
