package es.bsc.hp2c.edges.funcs;

import es.bsc.hp2c.HP2CEdges;
import es.bsc.hp2c.edges.types.Actuator;
...
import static es.bsc.hp2c.HP2CEdges.getEdgeLabel;
...
public class AmqpPublish extends Func {
    ...
    public AmqpPublish(ArrayList<Sensor<?, ?>> sensors, ArrayList<Actuator<?>> actuators, JSONArray others)
        ...
        edgeId = getEdgeLabel();
        channel = HP2CEdges.getChannel();
        EXCHANGE_NAME = HP2CEdges.getExchangeName();
